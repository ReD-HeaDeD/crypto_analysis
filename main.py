...
def coin_listing():
    ...
    cryptocurrency = call.json()['baseAsset'] #и по параметру symbols находим отрезок наименования коина
...
if __name__ == '__main__':
    ...
    with Pool(26) as p: #multiprocessing, спасибо тебе! но тут стоит еще и почитать за multitreding
